...
export default function BlueCard({ score, gemType, cost, onClick, disabled = false }) {
  ...
  console.log('BlueCard gemType:', gemType, 'backgroundImage:', backgroundImage);
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: disabled ? 'none' : '0px 2px 4px rgba(0,0,0,0.3)',
